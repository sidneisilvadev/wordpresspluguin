...
class AICG_Content {
    ...
    private function get_available_models() {
        ...
        return array(
            ...
            'nvidia/llama-3.1-nemotron-70b-instruct:free' => 'NVIDIA LLaMA 3.1 Nemotron 70B',
            'mistralai/mistral-nemo:free' => 'Mistral Nemo',
            
            // Modelos existentes
            'liquid/lfm-40b:free' => 'Liquid: LFM 40B MoE',
            ...
            'nousresearch/hermes-3-llama-3.1-405b:free' => 'Nous: Hermes 3 405B Instruct',
